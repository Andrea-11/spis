...
public function search_client()
{
    if ($this->session->userdata('user_type') == 'admin') {
        if ($this->input->post('idcbPlanUpdateStatus')) {
            ...
            $this->Main_model->update_data_cb_plan_model($cb_plan_id, $dataEditxss);
        ...
        $data['client_table'] = $this->Main_model->client_table_model();
...
public function add_client()
{
    if ($this->session->userdata('user_type') == 'admin') {
        ...
        $id_validation = $this->Main_model->id_validation_model();
        $new_id = "";
        $formatted_id = "";
        ...
        if ($this->input->post('addClientSubmit')) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $this->Main_model->insert_client_model($dataAddxss);
                ...
                if($this->db->insert('tbl_sc_representative',$dataxss)){ 
        ...
        $data['region'] = $this->Main_model->fetch_user_region();
...
public function osca_id_check($str) {
    ...
    // Debugging
    $checkActivityTitle = $this->Main_model->getActivityTitle($con);
...
function fetch_province()
{
 ...
 {
  echo $this->Main_model->fetch_province_model($this->input->post('region_id'));
 }
}
...
function fetch_city()
{
 ...
 {
  echo $this->Main_model->fetch_city_model($this->input->post('province_id'));
 }
}
...
function fetch_brgy()
{
 ...
 {
  echo $this->Main_model->fetch_brgy_model($this->input->post('city_id'));
 }
}
