...
// $config['upload_path'] = './assets/uploads/'; // Directory where the files will be uploaded
// $config['allowed_types'] = 'gif|jpg|png|pdf'; // Allowed file types
// $config['max_size'] = 100; // Maximum file size in kilobytes
// $config['max_width'] = 1024; // Maximum width of image files
// $config['max_height'] = 768; // Maximum height of image files
